...
interface RootTextareaProps extends React.TextareaHTMLAttributes<HTMLTextAreaElement> {
  label: string;
  htmlFor: string;
  error?: string;
}

const RootTextarea = forwardRef<HTMLTextAreaElement, RootTextareaProps>(
      ...
      <div className="flex flex-col">
        ...
        >
          ...
          <Textarea
            ...
            ref={ref}
            {...props}
            className="focus-visible:ring-0  bg-transparent shadow-none border-none px-2 min-h-[80px] resize-y"
          />
          {error && (
            <motion.p
...
RootTextarea.displayName = "RootTextarea";
